-- ============================================================
-- Quiz26 — Safe Schema (CREATE IF NOT EXISTS — data preserving)
-- ============================================================
...
-- ALTER TABLE statements (run only if columns don't exist)
-- D1 supports ALTER TABLE ADD COLUMN but only adds if not exists
